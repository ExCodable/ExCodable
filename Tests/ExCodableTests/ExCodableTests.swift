...
struct TestCustomEncodeDecode: Equatable {
    ...
    @ExCodable(encode: { encoder, value in encoder["nested.nested.string"] = value },
               decode: { decoder in return decoder["nested.nested.string"/*, typeConverter: Self.self*/] })
    var string: String? = nil
    
    @ExCodable(encode: { encoder, value in encoder[Keys.bool] = value },
               decode: { decoder in return decoder[Keys.bool/*, typeConverter: Self.self*/] })
    var bool: Bool = false
}
...
extension TestCustomEncodeDecode: Codable {
    ...
    init(from decoder: Decoder) throws {
        ...
        string = decoder["nested.nested.string"/*, typeConverter: Self.self*/]
...
extension TestSubscript: Encodable, Decodable {
    ...
    init(from decoder: Decoder) throws {
        // - seealso:
        // string = decoder.decode(Keys.string, as: String.self, typeConverter: Self.self)!
        // string = try decoder.decodeThrows(Keys.string, as: String.self, typeConverter: Self.self)!
        // string = try decoder.decodeNonnullThrows(Keys.string, as: String.self, typeConverter: Self.self)
        int = decoder[Keys.int/*, typeConverter: Self.self*/] ?? 0
        string = decoder[Keys.string/*, typeConverter: Self.self*/] ?? ""
    }
    func encode(to encoder: Encoder) throws {
        // - seealso:
...
extension TestTypeConversions: Encodable, Decodable {
    ...
    init(from decoder: Decoder) throws {
        boolFromInt = decoder[Keys.boolFromInt/*, typeConverter: Self.self*/]
        boolFromString = decoder[Keys.boolFromString/*, typeConverter: Self.self*/]
        intFromBool = decoder[Keys.intFromBool/*, typeConverter: Self.self*/]
        intFromDouble = decoder[Keys.intFromDouble/*, typeConverter: Self.self*/]
        intFromString = decoder[Keys.intFromString/*, typeConverter: Self.self*/]
        uIntFromBool = decoder[Keys.uIntFromBool/*, typeConverter: Self.self*/]
        uIntFromString = decoder[Keys.uIntFromString/*, typeConverter: Self.self*/]
        doubleFromInt64 = decoder[Keys.doubleFromInt64/*, typeConverter: Self.self*/]
        doubleFromString = decoder[Keys.doubleFromString/*, typeConverter: Self.self*/]
        floatFromInt64 = decoder[Keys.floatFromInt64/*, typeConverter: Self.self*/]
        floatFromString = decoder[Keys.floatFromString/*, typeConverter: Self.self*/]
        stringFromBool = decoder[Keys.stringFromBool/*, typeConverter: Self.self*/]
        stringFromInt64 = decoder[Keys.stringFromInt64/*, typeConverter: Self.self*/]
        stringFromDouble = decoder[Keys.stringFromDouble/*, typeConverter: Self.self*/]
    }
